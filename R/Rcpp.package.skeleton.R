  ...
  # first let the traditional version do its business
	...
	if( file.exists( DESCRIPTION ) ){
		depends <- c(
			...
			sprintf( "Rcpp (>= %s)", packageDescription("Rcpp98")[["Version"]] )
		)
	...
	skeleton <- system.file( "skeleton", package = "Rcpp98" )
	...
	if( example_code ){
		...
		unlink( hello.Rd )
		file.copy(
			system.file("skeleton", "rcpp_hello_world.Rd", package = "Rcpp98" ),
			hello.Rd
			)
	...
	if( isTRUE( module ) ){
		file.copy(system.file( "skeleton", "rcpp_module.cpp", package = "Rcpp98" ), file.path( root, "src" ))
		file.copy(system.file( "skeleton", "Num.cpp", package = "Rcpp98" ), file.path( root, "src" ))
		file.copy(system.file( "skeleton", "stdVector.cpp", package = "Rcpp98" ), file.path( root, "src" ))
		file.copy(system.file( "skeleton", "zzz.R", package = "Rcpp98" ), file.path( root, "R" ))
