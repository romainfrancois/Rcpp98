...
void init_Rcpp98_routines(DllInfo *info){
...
void registerFunctions(){
    ...
    #define RCPP_REGISTER(__FUN__) R_RegisterCCallable( "Rcpp98", #__FUN__ , (DL_FUNC)__FUN__ );
    ...
    RCPP_REGISTER(get_Rcpp98_namespace)
...
extern "C" void R_unload_Rcpp98(DllInfo *info) {
  /* Release resources. */
}

extern "C" void R_init_Rcpp98( DllInfo* info){
	setCurrentScope(0) ;
